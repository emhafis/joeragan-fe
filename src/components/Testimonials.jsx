  ...
  const testimonials = [
    {
      ...
      text: "Pelayanan sangat ramah dan profesional. Saya merasa sangat diperhatikan dari awal sampai akhir.",
      rating: 5,
    },
    {
      name: "Awalluddin",
      source: "Google Review",
      avatar: "/images/dummy.png",
      text: "Sebelum kesini lihat review di gmaps, ternyata setelah datang sendiri lebih dari ekspektasi. Ramah, komunikatif, anak-anak nyaman banget!",
      rating: 5,
    },
    {
      name: "Kamaruddin",
      source: "Google Review",
      avatar: "/images/dummy.png",
      text: "Dokternya sangat teliti dan sabar menjelaskan. Ruangannya bersih dan nyaman.",
      rating: 5,
    },
  ];
